...
public class Account {
    ...
    public Account(String uname, String bdate, String loc, Account[] accs) {
        ...
        following = new LinkedList<Integer>();
        followers = new LinkedList<Integer>();
    ...
    public void checkNoutbox() {
        System.out.println("You have " + outbox.size() + " in outbox");;
    }
    ...
    public void checkNinbox() {
        System.out.println("You have " + inbox.size() + " in inbox");;
    }
    ...
    public boolean unfollow(Account otherUser) {
        ...
        if (loggedin && otherUser != null) {
            ...
            if (following.contains(otherUser.getID())) {
                following.remove(Integer.valueOf(otherUser.getID()));
     ...
     */
    private boolean contains(LinkedList<Integer> array, int value) {
        for (var i : array) {
            if (i != null && i == value) {
                return true;
            }
