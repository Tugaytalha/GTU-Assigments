...
public class Post {
    ...
    /**
     * Getter for the non-deleted number of comments
     *
     * @return The number of comments.
     */
    public int getNdcomment() {
        return comments.ndsize();
    }
    ...
    /**
     * Getter for the non-deleted number of likes.
     *
     * @return The number of likes.
     */
